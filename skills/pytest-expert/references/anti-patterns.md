...
| `assert status == "active"` | Rule 3 | `assert status == UserStatus.ACTIVE` |
...
| `mocker.patch("src.service.InternalHelper")` | Rule 6 | Only patch external I/O boundaries |
| `mocker.patch("src.validators.Validator")` | Rule 6 | Let internal validators run for real |
